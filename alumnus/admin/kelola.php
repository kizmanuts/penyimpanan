            ...
            <table border="1" cellspacing="0" cellpadding="10">
                ...
                ?>
                    <tr align="center">
                        ...
                        <td><a href='edit.php?id=<?php echo $rowAlumnus['id']?>'>Edit</a> <a href='hapus.php?id=<?php echo $rowAlumnus['id']?>'>Hapus</a></td>
                    </tr>
                    </tr>
                <?php
                }
            ...
            <table border="1" cellspacing="0" cellpadding="10">
                ...
                ?>
                    <tr align="center">
                        ...
                        <td><a href='edit.php?id=<?php echo $rowAll['id']?>'>Edit</a> <a href='hapus.php?id=<?php echo $rowAll['id']?>'>Hapus</a></td>
                    </tr>
                <?php
                }
                ?>
